...
| W3 계정재분류 | `계정분류_모델아키텍처.md`(§2 유형·§3 방법) + `M사_DCF_교육_정본.md`(§1.4 Valuation B/S 재분류) |
| W4 추정 | `M사_리포트예시_클래시스.md`(§2 주요가정·부록A~D) + `모델링_실무_2강4강.md`(P×Q) |
...
| W7 시나리오 | `M사_리포트예시_클래시스.md`(부록F Driver+CHOOSE 토글) |
| W8 민감도 | `앤트로픽_금융스킬_벤치마크.md`(§1 중심셀=base 검증) |
| W9 리포트 | `M사_리포트예시_클래시스.md` + `장표_작성법.md` |
...
| 감사인 트랙 | `외부평가의견서_고정양식_구조.md` + `D사_감사인검토_WACC방법론.md` |

## ⚠️ M사 복제 금지

`M사_*`·`계정분류_*` 문서는 **방법론 지식**(무엇을 계산·검증할지)으로만 쓴다. 시트명(H_FS/EBIT/
