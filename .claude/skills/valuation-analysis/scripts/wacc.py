#!/usr/bin/env python
"""WACC 산정 (Skill 도구) — CAPM 빌드업 + β/MRP 정합 검증.

판단(β 출처·규모)은 LLM, 산식은 이 스크립트. calc_core.wacc 얇은 호출.
...
from calc_core.wacc import (  # noqa: E402
    WaccInputs, build_wacc, kroll_size_decile,
)
