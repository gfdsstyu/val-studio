# 회계법인 (회계법인 Easy View) UI/UX 벤치마크

## 개요
이 문서는 업로드된 **'회계법인 Easy View'** 화면을 바탕으로 `valuation-platform (val-studio)`의 정통 엔터프라이즈(대형 회계법인) UI/UX 구현을 위한 가이드라인을 정의합니다.

## 핵심 UI 원칙 (Enterprise Professional Aesthetic)
...
*   **Brand/Point Color:** 회계법인 고유의 오렌지색.
