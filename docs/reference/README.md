...
| [msvalue_DCF_교육_정본](msvalue_DCF_교육_정본.md) | ⭐ **DCF 이론 백본(도식 Mermaid 재현)**: 3대 접근법·FCFF/FCFE·BS 재분류·재투자 루프·FCFF 산출·WACC(MRP·Hamada·조정베타·size)·TV 정규화·**K-IFRS 1036.35 VIU 5년 상한** | MSVALUE 교육 hardcopy 38p |
