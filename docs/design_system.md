...
*   **Primary Brand Color:** `Burgundy Wine` (버건디 와인)
    ...
    *   **상징성:** 럭셔리, 흔들리지 않는 권위, 묵직한 신뢰감. 글로벌 투자은행 및 프리미엄 금융 소프트웨어의 감성을 차용하여, 타 빅4(오렌지, 파랑, 초록, 노랑)와 완벽히 차별화하면서도 금융권 특유의 보수적인 안정감을 줍니다.

## 2. 핵심 UI/UX 원칙 (Enterprise Big 4 Aesthetic)
